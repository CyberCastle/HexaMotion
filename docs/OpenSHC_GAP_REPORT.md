...
| `GaitDesignation`    | `WAVE_GAIT`, `AMBLE_GAIT`, `RIPPLE_GAIT`, `TRIPOD_GAIT`                                                    | `GaitType` in `gait_types.h`                          | `WAVE_GAIT`, `RIPPLE_GAIT`, `TRIPOD_GAIT`, `NO_GAIT`, `METACHRONAL_GAIT`, `ADAPTIVE_GAIT`                                                  | **Gap**: `AMBLE_GAIT` missing. **Added**: `METACHRONAL_GAIT`, `ADAPTIVE_GAIT`.                                                                                       |
...
| `PlannerMode`        | `PLANNER_MODE_OFF`, `PLANNER_MODE_ON`                                                                      | —                                                     | —                                                                                                                                          | **Gap**: By design (no external planner on MCU).                                                                                                                     |
