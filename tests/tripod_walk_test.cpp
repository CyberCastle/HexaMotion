 ...
 *   - run_tripod_linearity()
 *   - run_tripod_walk_visualization()
 */
...
// ===========================================================================
// Sub-test: run_tripod_linearity (from tripod_linearity_test.cpp)
// ===========================================================================
namespace cm_tripod_linearity_test {
/**
...
// ===========================================================================
// Sub-test: run_tripod_walk_visualization (from tripod_walk_visualization_test.cpp)
// ===========================================================================
namespace cm_tripod_walk_visualization_test {
/**
...
int run_tripod_walk_visualization() {
    // 1. Initialization
...
int main() {
    ...
    std::cout << "\n========== tripod linearity ==========\n";
    rc |= cm_tripod_linearity_test::run_tripod_linearity();

    std::cout << "\n========== tripod walk visualization ==========\n";
    rc |= cm_tripod_walk_visualization_test::run_tripod_walk_visualization();

    std::cout << "\n[tripod_walk_test] overall: " << (rc == 0 ? "PASS" : "FAIL") << "\n";
    return rc == 0 ? 0 : 1;
}
